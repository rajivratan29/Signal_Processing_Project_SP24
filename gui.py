...
from PyQt6.QtWidgeimportts import (QApplication,QWidget,QLabel,QComboBox,QLineEdit,QPushButton,QMessageBox,QFileDialog)
...
from audio import (save_audio,load_audio)
# Create application
...
stft_button = QPushButton("Show STFT",parent=window)

stft_button.move(50, 600)
stft_button.resize(300, 40)

generated_signal = None
generated_sample_rate = None

save_button = QPushButton("Save Audio",parent=window)

save_button.move(50, 650)
save_button.resize(300, 40)  
...
load_button.move(50, 700)
load_button.resize(300, 40)
...
stft_button.clicked.connect(show_stft)

save_button.clicked.connect(save_signal)

load_button.clicked.connect(load_audio_file)
# --------------------------------------------------
# Start GUI
# --------------------------------------------------
window.show()
